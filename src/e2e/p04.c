...
// clang-format on
static PyObject *py_e2e_p04_protect(PyObject *module, PyObject *args, PyObject *kwargs)
{
    Py_buffer      data;
...
PyDoc_STRVAR(e2e_p04_check_doc,
             "e2e_p04_check(data: bytearray, length: int, data_id: int, *, offset: int = 0) -> bool \n"
             ...
             "    the following condition: ``12 <= length <= len(data)`` \n"
             ":param int data_id: \n"
             "    A unique identifier which is used to protect against masquerading. \n"
             ":param int offset: \n"
             "    Byte offset of the E2E header. \n"
             ":return: \n"
...
static PyObject *py_e2e_p04_check(PyObject *module, PyObject *args, PyObject *kwargs)
{
    Py_buffer      data;
    unsigned short length;
    unsigned long  data_id;
    ...
    if (data.len < P04HEADER_LEN) {
        PyErr_SetString(PyExc_ValueError,
                        "The length of bytearray \"data\" must be greater or equal to 12.");
        goto error;
    }
    if (length < P04HEADER_LEN || length > data.len) {
        PyErr_SetString(PyExc_ValueError,
...
static struct PyMethodDef methods[] = {
    {"e2e_p04_protect", (PyCFunction)py_e2e_p04_protect, METH_VARARGS | METH_KEYWORDS, e2e_p04_protect_doc},
    {"e2e_p04_check",   (PyCFunction)py_e2e_p04_check,   METH_VARARGS | METH_KEYWORDS, e2e_p04_check_doc},
    {NULL} // sentinel
};
// clang-format on

// Module execution function for multi-phase initialization
static int p04_exec(PyObject *module)
{
...
static PyModuleDef_Slot p04_slots[] = {{Py_mod_exec, (void *)p04_exec},
#ifdef Py_GIL_DISABLED
                                       {Py_mod_gil, Py_MOD_GIL_NOT_USED},
#endif
                                       {0, NULL}};

// Module definition using slots
static struct PyModuleDef p04_module = {PyModuleDef_HEAD_INIT,
                                        .m_name    = "e2e.p04",
                                        .m_doc     = "",
                                        .m_size    = 0, // 0 for no state, change if using module state
                                        .m_methods = NULL, // Set in exec
                                        .m_slots   = p04_slots};

// Init function
PyMODINIT_FUNC            PyInit_p04(void) { return PyModuleDef_Init(&p04_module); }
