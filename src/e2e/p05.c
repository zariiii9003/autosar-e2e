...
// Exec function for multi-phase initialization
...
// Slot definitions with version-safe GIL and interpreter support
static PyModuleDef_Slot p05_slots[] = {
    {Py_mod_exec, (void *)p05_exec},
...
// Module definition
static struct PyModuleDef p05_module = {
...
{
    return PyModuleDef_Init(&p05_module);
}
